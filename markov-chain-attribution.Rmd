...
####Post in progress. Stable development release updated on: 2018-10-14
Current State:   
...
1. Access to a Google Analytics account with multi-channel funnels enabled and set up:
  ...
  ii) Once you have access to create goals, create a new custom goal that will count a goal completion **every time a user visits**. If you don't know how to set this up, follow my separate post with instructions here <link>
